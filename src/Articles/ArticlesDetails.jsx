                        ...
                        <div className="relative mt-[76px]">
                            <div className="ml-[-20px] lg:ml-auto w-[calc(100%+40px)] lg:w-[75%] mr-[-118px] overflow-hidden">
                                <div className="relative overflow-hidden pb-[56%]">
                                    <img className="absolute top-0 left-0 w-full h-full object-cover" src={details.image_details !== null ? URL + details.image_details : '/dist/images/test.png'} alt="" />
                                </div>
                            </div>
                                ...
                                ? (
                                    <div className="w-96 h-full bg-white">
                                        <div className="relative p-6 space-y-6 lg:p-8">
                                            ...
                                            <Link to="/billetterie" className="block w-full py-3 px-6 text-center rounded-xl transition bg-orange-600 hover:bg-orange-700">
