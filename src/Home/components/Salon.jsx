                    ...
                    <div className="max-w-7xl">
                        <div className="sm:mt-24 md:mx-auto lg:mx-0 lg:mt-0">
                            ...
                            <table className="min-w-full">
                                <tbody>
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste-black text-[40px] lg:text-[55px] font-heading_bold tracking-[0.566667px] leading-[.95] uppercase">{settings.halls}</td>
                                    ...
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste-black text-[40px] lg:text-[55px] font-heading_bold tracking-[0.566667px] leading-[.95] uppercase">{settings.exposants}</td>
                                    ...
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste-black text-[40px] lg:text-[55px] font-heading_bold tracking-[0.566667px] leading-[.95] uppercase">{settings.scenes}</td>
