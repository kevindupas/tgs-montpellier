    ...
    // TODO: Modifier les nombres dans l'admin salon
        <section className="relative w-full py-16 sm:py-24 bg-zinc-900">
            ...
            <div className="max-w-[1200px] w-[calc(100%-30px)] mx-auto flex justify-start items-start flex-wrap">
                ...
                <div className="grid grid-cols-1 gap-4 mx-auto lg:flex justify-center items-center w-full h-full">
                        ...
                        <div className="mr-0 relative z-10 text-white">
                            ...
                            <table className="min-w-full justify-center items-center">
                                <tbody>
                                    ...
                                    {/* <tr>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste text-[40px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase">{ settings.scenes }</td>
                                        <td className="whitespace-nowrap px-3 py-4 pt-[25px] text-sm text-white flex-shrink-0 font-tungstenb_semibold font-semibold text-[45px] tracking-[0.566667px] leading-[.95] uppercase">scènes</td>
                                    </tr> */}
                                    {/* <tr>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste text-[40px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase">{ settings.invites }</td>
                                        <td className="whitespace-nowrap px-3 py-4 pt-[25px]  text-sm text-white flex-shrink-0 font-tungstenb_semibold font-semibold text-[45px] tracking-[0.566667px] leading-[.95] uppercase">guest</td>
                                    </tr> */}
                                </tbody>
                            </table>
                                                            ...
                                                            <ul className="flex space-x-4 mt-4">
...

                                                                {
                                                                    data.instagram !== null && (
                                                                        <li className="">
                                                                            <a
                                                                                href="https://www.facebook.com/hellfest/"
                                                                                target="_blank"
                                                                                className="w-7 block"
                                                                                rel="noreferrer"
                                                                            >
