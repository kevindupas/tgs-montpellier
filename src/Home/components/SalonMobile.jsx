                ...
                <div className="relative isolate overflow-hidden">
                    <div className="max-w-7xl">
                        <div className="sm:mt-24 md:mx-auto lg:mx-0 lg:mt-0 pt-10">
                            ...
                            <table className="min-w-full">
                                <tbody>
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right font-medium text-gray-900 sm:pl-6 artiste-black text-3xl font-heading_bold tracking-[0.566667px] leading-[.95] uppercase pt-6">{settings.halls}</td>
                                    ...
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right font-medium text-gray-900 sm:pl-6 artiste-black text-3xl font-heading_bold tracking-[0.566667px] leading-[.95] uppercase pt-6">{settings.exposants}</td>
                                    ...
                                    <tr>
                                        <td className="whitespace-nowrap pl-4 pr-3 text-right font-medium text-gray-900 sm:pl-6 artiste-black text-3xl font-heading_bold tracking-[0.566667px] leading-[.95] uppercase pt-6">{settings.scenes}</td>
                    ...
                    <div className="mt-10 mb-4 flex justify-center items-center">
                        <a href="https://photos.tgs-montpellier.fr" target="_blank" className="inline-block text-center cursor-pointer py-5 px-11" rel="noreferrer">
                            <button
                                type="button"
                                className="rounded-lg bg-orange-500 py-2.5 px-3.5 text-3xl border-2 text-white shadow-sm uppercase font-bold"
                            >
                                Découvrir le salon
                            </button>
                        </a>
