                            ...
                            <ul className="grid">
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        href={`https://www.billetweb.fr/shop.php?event=${settings.ticket_link}`}
                                        className="shop_frame"
                                        target="_blank"
                                        data-src={`https://www.billetweb.fr/shop.php?event=${settings.ticket_link}`}
                                        data-max-width="100%"
                                        data-initial-height="600"
                                        data-scrolling="no"
                                        data-id={settings.ticket_link}
                                        data-resize="1"
                                        rel="noreferrer"
                                    >
