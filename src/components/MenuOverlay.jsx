                    ...
                    { isDesktop && (
                        <ul className="h-full list-none pl-0 m-0 flex justify-around flex-col">
                            <li className="flex">
                                <Link
                                    to="faqs"
                                    className="hover-this relative flex text-[40px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase menu__item-link hover:text-orange-700"
                                    onClick={() => {
                                        setNavbarOpen(false);
                                    }}
                                >
                            ...
                            <li className="flex">
                                <Link
                                    to="/"
                                    className="relative flex text-[40px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase menu__item-link hover:text-orange-700"
                                    onClick={() => {
                                        setNavbarOpen(false);
                                    }}
                                >
                    ...
                    { isMobile && (
                        <ul className="h-full list-none pl-0 m-0 flex justify-around flex-col">
                            <li className="flex">
                                <Link
                                    to="invites"
                                    className="relative flex text-[30px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase menu__item-link hover:text-orange-700"
                                    onClick={() => {
                                        setNavbarOpen(false);
                                    }}
                                >
                            ...
                            <li className="flex">
                                <Link
                                    to="exposants"
                                    className="hover-this relative flex text-[30px] lg:text-[68px] font-microgramma tracking-[0.566667px] leading-[.95] uppercase menu__item-link hover:text-orange-700"
                                    onClick={() => {
                                        setNavbarOpen(false);
                                    }}
                                >
